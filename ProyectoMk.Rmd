...
*Reporte de casos de violencia Mellitus(tipo 2) por Fuente/Institucion*
```{r, echo=FALSE}
str(violencia.intrafamiliar.fuente)
```

*Reporte de casos de violencia Mellitus(tipo 2) por Grupo de Edad*
```{r, echo=FALSE}
str(violencia.intrafamiliar.edad)
```

*Reporte de casos de violencia Mellitus(tipo 2) por Mes*
```{r, echo=FALSE}
str(violencia.intrafamiliar.mes)
```
