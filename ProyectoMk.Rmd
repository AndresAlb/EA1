...
#violencia.intrafamiliar.fuente$TOTAL <- apply(FUENTE[,-10],2,function(x) sum(x,na.rm=TRUE))
...
#violencia.intrafamiliar.mes$TOTAL- apply(MES[,-10],2,function(x) sum(x,na.rm=TRUE))
...
#violencia.intrafamiliar.edad$TOTAL <- apply(EDAD[,-10],2,function(x) sum(x,na.rm=TRUE))
