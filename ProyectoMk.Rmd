...
Para observar el fen??meno de violencia intrafamiliars en el mes de mayo generamos la siguiente tabla, misma que contiene el n??mero promedio de violencia intrafamiliars por entidad durante el periodo de observaci??n para el mes de mayo.

```{r Promedios Mayo, echo=FALSE}
